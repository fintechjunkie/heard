    ...
    <BottomSheet open={open} onClose={handleClose} fullHeight>
      <div className="h-full flex flex-col">
          ...
          <div className="flex gap-2 items-center">
            {[1, 2, 3].map(s => (
              <div key={s} className="flex items-center gap-2">
                <div className="w-[24px] h-[24px] rounded-full flex items-center justify-center text-caption font-medium"
                  style={{
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide p-5">
          {step === 1 && (
            <>
              <div className="text-caption tracking-[2px] uppercase mb-3" style={{ fontFamily: "'DM Mono', monospace", color: '#5a5650' }}>
                Step 1 — Contract Review
              </div>
              <div className="rounded-xl p-4 mb-4 text-label leading-[1.6] overflow-y-auto max-h-[300px] scrollbar-hide"
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-body leading-[1.5]" style={{ color: '#5a5650' }}>
          ...
          {step === 2 && (
            <>
              ...
              <p className="text-label mb-4" style={{ color: 'var(--muted)', lineHeight: 1.5 }}>
              ...
              <div className="flex flex-col gap-3">
                {['Firm / Cardholder Name', 'Card Number', 'Expiry', 'CVV', 'Billing Email'].map(label => (
                  <div key={label}>
                    <div className="text-caption tracking-[1px] uppercase mb-1" style={{ fontFamily: "'DM Mono', monospace", color: '#6a6660' }}>{label}</div>
                    <input
          ...
          {step === 3 && (
            <>
              ...
              <div className="text-center mb-5">
                ...
                <div className="text-body" style={{ color: '#6a6660' }}>
              ...
              <div className="rounded-xl overflow-hidden" style={{ background: 'var(--black)' }}>
                {[
                  ...
                  <div key={i} className="flex items-center justify-between px-4 py-[10px]"
                    ...
                    <span className="text-caption tracking-[1px] uppercase" style={{ fontFamily: "'DM Mono', monospace", color: 'rgba(255,255,255,0.45)' }}>{label}</span>
        ...
        <div className="flex-shrink-0 px-5 pb-5 pt-3" style={{ borderTop: '1px solid var(--border)' }}>
          <button
            ...
            className="w-full py-[14px] rounded-xl text-label tracking-[1.5px] uppercase cursor-pointer border-none transition-opacity"
            style={{
              fontFamily: "'DM Mono', monospace",
